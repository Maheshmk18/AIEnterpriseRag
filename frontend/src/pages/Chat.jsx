...
function Chat() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const assistantResponse = response.data?.response || response.data?.message || 'I received your message but could not generate a response.';
      ...
      setMessages(prev => [
        ...prev,
        { role: 'assistant', content: `I apologize, but I couldn't process that request. ${errorMessage}` }
      ]);
    } finally {
      setLoading(false);
    }
